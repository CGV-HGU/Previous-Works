...
class RobotTracker:
    def __init__(self, map_image_path):
        ...
        pygame.init()
        self.screen = pygame.display.set_mode((3000, 1000))
    ...
    def camera_pose_callback(self, msg):
        #############################################
        #### map_0717.jpg
        #### file name  -> oh_3f_0717
        scale_factor = 25 // 2
        # grid_min = (-599 // 2, -198 // 2)
        # grid_max = (401 // 2, 2802 // 2)
        grid_min = (-859 // 2, -226 // 2)
        grid_max = (119 // 2, 236 // 2)
        #############################################
...
if __name__ == "__main__":
    map_image = '/home/cgvlab/catkin_ws/src/convert2d_pose/src/map_0723.png'
